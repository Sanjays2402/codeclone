  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      >
        ...
        <NavBar />
        <WelcomeBanner />
        <main className="mx-auto max-w-[1280px] px-4 sm:px-7 pb-24 pt-6">
          {children}
        </main>
        <PWAInstall />
        <Toaster />
        <footer className="mx-auto max-w-[1280px] px-4 sm:px-7 py-10 text-[11px] mono text-[var(--color-ink-4)] break-words">
